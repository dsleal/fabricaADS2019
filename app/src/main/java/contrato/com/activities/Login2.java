...
public class Login2 extends AppCompatActivity {
    ...
    public void acessar(View view) {
        ...
        if (tipo.equals("Administrador")) {
            startActivity(new Intent(Login2.this, Administrador.class));
        } else if (tipo.equals("Cliente")) {
            startActivity(new Intent(Login2.this, PainelCliente.class));
        } else if (tipo.equals("Prestador")) {
            startActivity(new Intent(Login2.this, PainelPrestador.class));
        } else {
